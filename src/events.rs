...
pub enum EventType {
    ...
    UpdateOscillator1Tuning(i32),
    UpdateOscillator2Tuning(i32),
    UpdateOscillator3Tuning(i32),
    UpdateSubOscillatorTuning(i32),
    UpdateOscillator1Level(f32),
    UpdateOscillator2Level(f32),
    UpdateOscillator3Level(f32),
    UpdateSubOscillatorLevel(f32),
    UpdateOscillator1FMAmount(i32),
    UpdateOscillator2FMAmount(i32),
    UpdateOscillator3FMAmount(i32),
    UpdateSubOscillatorFMAmount(i32),
    UpdateOscillator1ShaperAmount(f32),
    UpdateOscillator2ShaperAmount(f32),
    UpdateOscillator3ShaperAmount(f32),
    UpdateSubOscillatorShaperAmount(f32),
